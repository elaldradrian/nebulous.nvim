...
function setup.load_colors(scheme, settings)
  ...
  local editor = {
    ...
    DiffAdd = { fg = scheme.Green, bg = scheme.none, style = scheme.none },
    DiffChange = { fg = scheme.Orange, bg = scheme.none, style = scheme.none },
    DiffDelete = { fg = scheme.Red, bg = scheme.none, style = scheme.none },
    DiffText = { fg = scheme.Yellow, bg = scheme.none, style = scheme.none },
    Directory = { fg = scheme.Blue, bg = scheme.none, style = "bold" },
    EndOfBuffer = { fg = settings.st_eof and scheme.background or scheme.Grey, bg = scheme.none, scheme.none },
    ...
    FoldColumn = { fg = scheme.LightGrey, bg = scheme.Grey, scheme.none },
    ...
    Special = { fg = scheme.Yellow, bg = scheme.none, scheme.none },
    ...
    Visual = { fg = scheme.Black, bg = scheme.White, style = scheme.none },
    VisualNOS = { fg = scheme.Black, bg = scheme.White, style = scheme.none },
    WarningMsg = { fg = scheme.DarkOrange, bg = scheme.none, scheme.none },
    Warnings = { fg = scheme.DarkOrange, bg = scheme.none, style = "reverse" },
    Whitespace = { fg = scheme.Grey, bg = scheme.none, scheme.none },
    ...
    -- Nvim tree
    NvimTreeEmptyFolderName = { fg = scheme.Grey, bg = scheme.none, scheme.none },
    ...
    HopUnmatched = { fg = scheme.Grey, bg = scheme.none, scheme.none },
    ...
    CmpItemAbbrDeprecated = { fg = scheme.Grey, bg = scheme.none, scheme.none },
    ...
    -- Notify
    NotifyBackground = { fg = scheme.none, bg = scheme.Black, scheme.none },

    -- BufferLine
    BufferLineIndicatorSelected = { fg = scheme.DarkOrange, bg = scheme.background, scheme.none },
    BufferLineFill = { fg = scheme.Grey, bg = scheme.Custom_1, scheme.none },

    -- Neotest
    NeotestAdapterName = { fg = scheme.White, bg = scheme.none, scheme.none },
    NeotestBorder = { fg = scheme.Yellow, bg = scheme.none, scheme.none },
    NeotestDir = { fg = scheme.Blue, bg = scheme.none, scheme.none },
    NeotestExpandMarker = { fg = scheme.LightGrey, bg = scheme.none, scheme.none },
    NeotestFailed = { fg = scheme.DarkRed, bg = scheme.none, scheme.none },
    NeotestFile = { fg = scheme.DarkBlue, bg = scheme.none, scheme.none },
    NeotestFocused = { fg = scheme.Cyan, bg = scheme.none, scheme.none },
    NeotestIndent = { fg = scheme.Grey, bg = scheme.none, scheme.none },
    NeotestMarked = { fg = scheme.Purple, bg = scheme.none, scheme.none },
    NeotestNamespace = { fg = scheme.Orange, bg = scheme.none, scheme.none },
    NeotestPassed = { fg = scheme.Green, bg = scheme.none, scheme.none },
    NeotestRunning = { fg = scheme.Aqua, bg = scheme.none, scheme.none },
    NeotestWinSelect = { fg = scheme.DarkBlue, bg = scheme.none, scheme.none },
    NeotestSkipped = { fg = scheme.Yellow, bg = scheme.none, scheme.none },
    NeotestTarget = { fg = scheme.Magenta, bg = scheme.none, scheme.none },
    ...
    AvanteTitle = { fg = scheme.White, bg = scheme.DarkBlue, scheme.none },
    AvanteReversedTitle = { fg = scheme.DarkBlue, bg = scheme.none, scheme.none },
    AvanteSubtitle = { fg = scheme.White, bg = scheme.DarkBlue, scheme.none },
    AvanteReversedSubtitle = { fg = scheme.DarkBlue, bg = scheme.none, scheme.none },
    AvanteThirdTitle = { fg = scheme.White, bg = scheme.DarkBlue, scheme.none },
    AvanteReversedThirdTitle = { fg = scheme.DarkBlue, bg = scheme.none, scheme.none },
    ...
    AvanteConflictCurrent = { fg = scheme.Blue, bg = scheme.Green, scheme.none },
    AvanteConflictIncoming = { fg = scheme.Cyan, bg = scheme.Red, scheme.none },
